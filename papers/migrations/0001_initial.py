    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(related_name='clusterrel',
                                              blank=True, to='papers.Author', null=True)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_annotation', models.CharField(
                    max_length=32, null=True, blank=True)),
                ('doctype', models.CharField(max_length=32, null=True, blank=True)),
                ('oa_status', models.CharField(default='UNK',
                                               max_length=32, null=True, blank=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL,
                                    blank=True, to='papers.Researcher', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='author',
            name='similar',
            field=models.ForeignKey(
                related_name='similarrel', blank=True, to='papers.Author', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
